...
class FingerTrackNode:
    def __init__(self):
        rospy.init_node('finger_track_2')
        ...
        try:
            ...
            if results is not None and results.multi_hand_landmarks:
                ...
                if self.state == State.NULL:
                    if gesture == "one":    # Only extend your index finger, and make fist with other fingers
                        self.start_count += 1
                    ...
                    if gesture == "five":
                        ...
                        track_img = cv2.fillPoly(track_img, [contour, ], (255, 255, 255)) # fill in
                        for _ in range(3):
                        ...
                        # Determine the shape according to the number of envelope lobes
                        if len(approx) == 3:
