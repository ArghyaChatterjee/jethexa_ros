...
class Fusion(object):
    ...
    def __init__(self):
        ...
        self.deltat = DeltaT()  # Time between updates
    ...
    def update_nomag(self, accel, gyro, ts=None):  # 3-tuples (x, y, z) for accel, gyro
        ...
        self.roll = degrees(
            atan2(2.0 * (self.q[0] * self.q[1] + self.q[2] * self.q[3]),
    ...
    def update(self, accel, gyro, mag, ts=None):  # 3-tuples (x, y, z) for accel, gyro and mag data
        ...
        s1 = (-_2q3 * (2 * q2q4 - _2q1q3 - ax) + _2q2 * (2 * q1q2 + _2q3q4 - ay) - _2bz * q3 *
              ...
              (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my) + _2bx * q3 * (_2bx * (q1q3 + q2q4) + _2bz *
                                                                                (0.5 - q2q2 - q3q3) - mz))

        s2 = (
            _2q4 * (2 * q2q4 - _2q1q3 - ax) + _2q1 * (2 * q1q2 + _2q3q4 - ay) - 4 * q2 *
            (1 - 2 * q2q2 - 2 * q3q3 - az) + _2bz * q4 * (_2bx * (0.5 - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx) +
            (_2bx * q3 + _2bz * q1) * (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my) + (_2bx * q4 - _4bz * q2) *
        ...
        s4 = (
            _2q2 * (2 * q2q4 - _2q1q3 - ax) + _2q3 * (2 * q1q2 + _2q3q4 - ay) + (-_4bx * q4 + _2bz * q2) *
            (_2bx * (0.5 - q3q3 - q4q4) + _2bz * (q2q4 - q1q3) - mx) + (-_2bx * q1 + _2bz * q3) *
            (_2bx * (q2q3 - q1q4) + _2bz * (q1q2 + q3q4) - my) + _2bx * q2 * (_2bx * (q1q3 + q2q4) + _2bz *
                                                                              (0.5 - q2q2 - q3q3) - mz))
        ...
        self.heading = self.declination + degrees(
            atan2(2.0 * (self.q[1] * self.q[2] + self.q[0] * self.q[3]),
                  self.q[0] * self.q[0] + self.q[1] * self.q[1] - self.q[2] * self.q[2] - self.q[3] * self.q[3]))
        self.pitch = degrees(-asin(2.0 * (self.q[1] * self.q[3] - self.q[0] * self.q[2])))
        self.roll = degrees(
            atan2(2.0 * (self.q[0] * self.q[1] + self.q[2] * self.q[3]),
