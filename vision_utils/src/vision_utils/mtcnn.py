...
class TrtMtcnn(object):
    ...
    def __init__(self):
        self.pnet = TrtPNet('/home/hiwonder/third_parts/tensorrt_demos/mtcnn/det1.engine')
        self.rnet = TrtRNet('/home/hiwonder/third_parts/tensorrt_demos/mtcnn/det2.engine')
        self.onet = TrtONet('/home/hiwonder/third_parts/tensorrt_demos/mtcnn/det3.engine')
    ...
    def _detect_1280x720(self, img, minsize):
        ...
        dets = self.pnet.detect(img, minsize=minsize, threshold=0.7)
        dets = self.rnet.detect(img, dets, threshold=0.5)
        dets, landmarks = self.onet.detect(img, dets, threshold=0.4)
